...
produtos.map((produto) => {
    if(produto.categoria === "Roupa") {
        produto.onSale = true // desse modo vai adicionar a propriedade onSale
    }
})
...
const {nome: nomeProduto, preco, categoria, cor} = detalhesProdutos; // caso queira mudar o nome da variavel é só colocar nome: nomeProduto
